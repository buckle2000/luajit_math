...
local is_number, is_vector2, hashxy, index_mt, mt, vector2
...
index_mt = {
  ...
  euclidean = function(v)
    return vector2(v:len(), atan2(v.x, v.y))
  end,
  ...
  eq = function(a, b)
    return is_vector2(a) and is_vector2(b) and a.x == b.x and a.y == b.y
  end,
  tostring = function(v)
